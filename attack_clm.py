...
def generate_attack(generate_m, generate_t, tgt_m, tgt_t, texts, evaluation_template, objective, iterations, top_n, top_m, top_k, warm_up, temperature, threshold, device):
    ...
    for iter in range(iterations):
        ...
        generate_model = AutoModelForCausalLM.from_pretrained(generate_m, output_hidden_states=True, load_in_8bit=True, use_flash_attention_2=False, cache_dir='./hf_models', device_map="auto").eval()
        ...
        if tgt_m != "gpt-4-0613" and tgt_m != "o1-preview-2024-09-12":
            tgt_model = AutoModelForCausalLM.from_pretrained(tgt_m, load_in_8bit=True, use_flash_attention_2=False, cache_dir='./hf_models', device_map="auto").eval()
